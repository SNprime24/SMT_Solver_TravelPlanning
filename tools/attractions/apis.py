...
class Attractions:
    def __init__(self, path="TravelPlanner_database/attractions/attractions.csv"):
        self.path = path
    ...
    def run_for_all_cities(self, all_cities,
        ...
        results = Array('attractions', IntSort(), IntSort()) # ori, dest, date, [Price, DepTime, ArrTime], info
