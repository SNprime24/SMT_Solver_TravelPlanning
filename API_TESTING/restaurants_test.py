from TripCraft_tools.restaurants.apis import Restaurants
...
def main():
    ...
    print("\n--- Testing check_exists(cuisine, restaurant_cuisines_list, index) ---")
    print("Does 'Chinese' exist at index 0?")
    restaurants.check_exists('Chinese', results_cuisines, 0)

    print("\n--- Testing run_for_annotation(city) ---")
    print(restaurants.run_for_annotation("New York (City Center)"))
